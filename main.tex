...
\include{Slides/Introducao/objetivos}

\section[]{Representação Intermediária de Código}
\include{Slides/Fundamentacao/RI/RI}
\subsection{Estilo de Passagem de Continuação (CPS)}
\include{Slides/Fundamentacao/RI/CPS/CPS}
\section[]{Teoria de Tipos}
\include{Slides/Fundamentacao/TeoriaTipos}
\section[]{Sistema Damas-Milner}
\include{Slides/Fundamentacao/DamasMilner/DamasMilner}
\subsection{Algoritmo W}
\include{Slides/Fundamentacao/DamasMilner/W-algo}

\section[]{Proposta}
\include{Slides/Proposta/Proposta}
\include{Slides/Proposta/Conclusao}
